...
const createUser = async (req, res) => {
  try {
    ...
    if (!validate.isValid(data.address.shipping))
      return res
        .status(400)
        .send({
          status: false,
    ...
    if (!validate.isValidString(data.address.shipping.pincode))
      return res
        .status(400)
    ...
    if (!validate.isValid(data.address.billing))
      return res
        .status(400)
        .send({
          status: false,
    ...
    if (!validate.isValidString(data.address.billing.pincode))
      return res
        .status(400)
        .send({ status: false, message: "Pincode should be in numbers" });
        ...
        if (shipping.street) {
          if (!validate.isValidString(shipping.street))
            return res
              ...
              .send({
                status: false,
                message: "Street Is Required,Should Be In String Value ",
              });
          ...
          if (!validate.isValidStreet(shipping.street))
            return res
              ...
              .send({
                status: false,
                message: "Enter Valid Street Of Shipping",
              });
        }
        ...
        if (shipping.city) {
          if (!validate.isValidString(shipping.city))
            return res
              ...
              .send({
                status: false,
                message: "City Is Required,Should Be In String Value ",
              });
        ...
        if (billing.street) {
          ...
          if (!validate.isValidStreet(billing.street))
            return res
              ...
              .send({
                status: false,
                message: "Enter Valid Street Of Billing",
              });
        }
